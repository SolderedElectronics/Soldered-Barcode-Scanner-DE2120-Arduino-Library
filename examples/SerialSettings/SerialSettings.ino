 ...
 **************************************************
 *
 * @file        SerialSettings.ino
 * @brief       Interactive configuration and scanning demo for the DE2120
 *              1D/2D barcode scanner module over SoftwareSerial.
 *
 *              Presents a Serial Monitor menu to control scanner settings
 *              at runtime: start/stop scanning, toggle the illumination
 *              flashlight and aiming reticle, adjust the reading area,
 *              switch reading modes (manual, continuous, motion), and
 *              enable or disable 1D/2D symbology groups.
 *
 *              While the menu is displayed the sketch continuously polls
 *              for barcodes, printing any result to Serial Monitor before
 *              waiting for the next menu selection.
 *
